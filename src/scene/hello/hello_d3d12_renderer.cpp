...
using crib::scene::hello_d3d12_renderer;


hello_d3d12_renderer::hello_d3d12_renderer(crib::graphics::d3d12_context& context, crib::scene::hello_scene& hello_scene) : d3d12_renderer(context), scene(hello_scene)
{
