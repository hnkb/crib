...
hello_d3d11_renderer::hello_d3d11_renderer(crib::graphics::d3d11_context& context, crib_scenes::hello::hello_scene& hello_scene) : d3d11_renderer(context), scene(hello_scene)
{
	// Set up pipeline
	{
